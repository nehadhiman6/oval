  ...
  onFail(errors,errorStatus) {
    ...
    if(errors.status != 422){
        ...
        if(errorStatus != false){
            if(typeof($('.serverError')[0]) == "undefined"){
            $($(".card-body")[0]).after("<div class='serverError' style='background: #dac111; padding: 10px 20px;text-align: center; color: #000;font-size: 16px;'><i class='fa fa-exclamation-triangle fa-2x' style='margin-right: 10px; vertical-align: middle;'></i>"+ msg +"</div>");
            // $("form").after("<div class='serverError' style='background: #dac111; padding: 10px 20px;text-align: center; color: #000;font-size: 16px;'><i class='fa fa-exclamation-triangle fa-2x' style='margin-right: 10px; vertical-align: middle;'></i>"+ errors.statusText +"</div>")
            }
            else{
