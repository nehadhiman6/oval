    ...
    <Modal :show="data.show" :max-width="modalSize" :closeable="closeable" @close="close" >
        <div class="px-6 py-4">
            ...
            <div class="mt-4 text-sm text-gray-600">
                ...
                <div class="flex -mx-3" v-for="(resource,index) in data.resources" :key="index">
                    <div class="w-full max-w-full px-3 md:w-1/12" v-if="props.numberAttachments != 1">
                        <div class="mb-4">
                            ...
                            <br>
                            <IconButton  @buttonClicked="removeResource(index)" icon="fa fa-trash ml-2 text-red-400 "> </IconButton>
                     ...
                     <div class="w-full max-w-full px-3 md:w-3/12 md:flex-0" v-if="props.docTypes.length > 0">
                        <div class="mb-4">
                            <SelectInput v-model="resource.doc_type" :options ="props.docTypes"  ></SelectInput>
                        </div>
                    </div>
                    <div class="w-full max-w-full px-3 md:w-6/12"  v-if="showDescription == true">
                        <div class="mb-4">
                            <TextAreaInput v-model="resource.doc_description"/>
                        </div>
                    </div>
                    <div :class="'w-full max-w-full px-3 md:w-'+columnSize+'/12'">
                        <div class="">
                ...
                <div class="flex -mx-3 " v-if="showAddButton">
        ...
        <div class="flex flex-row justify-end px-6 py-4 bg-gray-100 text-right">
            <div class="">
                <ButtonComp @buttonClicked="saveImages" type="save">Save</ButtonComp>
                <ButtonComp @buttonClicked="emit('updateStatus')" type="cancel">Cancel</ButtonComp>
            </div>
        </div>
